        ...
        for i in range(data7.shape[0]):
            ...
            while counter <= 15:
                ...
                if data7.iloc[i-counter]['candle_type'] == ('bearish'):
                    v = abs(data7.iloc[i-counter]['close'] - data7.iloc[i-counter]['open'])
                    a.append(v)
                    y.append(y)
...
def market_order7(symbol, volume, order_type,):
    if order_type == 'buy':
        ...
        request = {
            ...
            "tp": price_dict[order_type] + 9000* point,
            "magic": 100,
...
if __name__ == '__main__':
    ...
    mt.initialize()
    #mt.login(80777072, password='Pass1234')
    while True:
        cwd = os.getcwd()
        mydir = cwd
